const cdnBase = require("../config/index"); //首页商品数据列表
...
//   export function getgood() {        //自己设置的getgood请求
//     wx.request({
//       url: 'http://localhost:3000/goods/getGood',
//       success: function (res) {
//         // res.data contains the string "123"
...
function genGood(id, available = 1) {
  ...
  console.log(allGoods, "chulihanshu");
